...
# Ansible module to manage local docker machines
...
DOCUMENTATION = '''
---
module: docker_machine_local
short_description: Create a local docker host machine using docker-machine
description:
    - Manage the life cycle of a local docker machine
version_added: "2.2"
options:
  name:
    description:
...
def main():
    ...
    MachineManager(None, machine, results)
